...
console.log(`Hola  ${name} , esta es mi pre entrega del curso donde quise hacer un borrador sobre lo que podría ser mi portafolio`);
alert("Please, check the console. So you can get all the info");
